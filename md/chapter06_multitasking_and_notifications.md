...
> 版本说明（截至 2026 年 2 月）：本章以 Android 16（API 36）为基线，重点覆盖协程/WorkManager、后台限制、前台服务与通知渠道等现代实践；历史接口（如 AsyncTask、IntentService）仅用于理解演进并给出替代方案。
...
### 6.3.1 [生命周期](http://blog.csdn.net/fireofstar/article/details/7299443)
...
10
// or higher, you need to request the USE_FULL_SCREEN_INTENT
permission in
